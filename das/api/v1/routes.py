...
api_router.register('log_data', viewsets.Log_Value_View_Set, basename='log_data')
api_router.register('log_data_2', viewsets.Log_Value_View_Set_2, basename='log_data_2')
