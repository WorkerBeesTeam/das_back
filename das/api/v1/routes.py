...
api_router.register('log_value', viewsets.Log_Value_View_Set, basename='log_data')
api_router.register('chart_data', viewsets.Chart_Data_View_Set, basename='chart_data')
